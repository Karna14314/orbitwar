# HYPOTHESIS: Micro-Tune: Adjust combat tracking and reserve limits.
# ROUND: 1 | DATE: 2024-05-21
# BASED ON: champion.py
# CHANGELOG: Send min requirement lowered from 3 to 1.
"""
    ...
    for src in mine_sorted:
        ...
        while available_ships[src['id']] >= 4 and launches < 4:
            ...
            for tgt in targets:
                ...
                if angle is None or send < 1 or available_ships[src['id']] - send < required_reserve:
                    continue
