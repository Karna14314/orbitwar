# HYPOTHESIS: Hyper-aggressive hybrid intercept targeting high-prod moving targets.
# DATE: 2024-05-23
# BASED ON: agents/champion.py
# CHANGELOG: Increased moving target multiplier to 3.0 and base multiplier to 150.
...
def heuristic_moves(state, pid):
    ...
    for src in sorted(mine, key=lambda p: p['ships'], reverse=True):
        ...
        for tgt in targets:
            ...
            if tgt['id'] in state['moving']: score *= 3.0
