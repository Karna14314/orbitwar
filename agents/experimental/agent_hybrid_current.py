# HYPOTHESIS: Combining speed safety buffer of 1.4 with a neutral multiplier of 1.6 balances expansion aggression and intercept viability.
# DATE: 2026-06-04
# BASED ON: agents/champion.py
# CHANGELOG: Changed buffer to 1.4 and neutral multiplier to 1.6
import math
