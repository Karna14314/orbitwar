# HYPOTHESIS: Hybrid approach combining intercept logic for moving targets and rush logic for close static ones.
# DATE: 2024-05-20
# BASED ON: agent_intercept_current.py + agent_rush_current.py
# CHANGELOG: Initial version, blending early rush and precise intercept.
...
def agent(obs):
    ...
    for my_p in my_planets:
        ...
        for tgt in planets:
            ...
            # Score: Heavily favor neutral static planets early on, but switch to moving/enemy targets if better
            is_neutral = 1 if tgt['owner'] == -1 else 0
            score = dist_real - (tgt['production'] * 8) - (is_neutral * 15)
