# HYPOTHESIS: Concentric Wave Expansion targeting adjacent static neutrals early
# ROUND: 2 | DATE: 2026-06-01
# BASED ON: champion.py
# CHANGELOG: Multiplied inner-ring neutral target EV by 1.7 in first 60 turns
import math
...
def score_target(src, tgt, eta, is_comet, step, needed, mine, planets, pid, state, already_sent=0):
    ...
    if tgt['owner'] == -1:
        if step < 60 and min_dist_to_us < 20.0: ev *= 1.7
