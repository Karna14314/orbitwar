# HYPOTHESIS: Increasing early-game neutral capture multiplier to 1.7 inside the first 80 turns speeds up concentric expansion.
# DATE: 2026-06-04
# BASED ON: agents/champion.py
# CHANGELOG: Changed step < 60 to step < 80 and ev *= 1.5 to ev *= 1.7
import math
