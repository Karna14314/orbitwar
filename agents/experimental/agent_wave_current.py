# HYPOTHESIS: Wave Expansion targeting adjacent static neutrals and prioritizing inner rings (r < 30) for higher EV
# DATE: 2024-05-29
# BASED ON: champion.py
# CHANGELOG: Multiplied inner-ring neutral target EV by 1.5 in first 60 turns
import math
