# HYPOTHESIS: Adjusting triage threat_eta to 25.0 prevents abandoning viable planets too early while still dodging overwhelming doom.
# DATE: 2026-06-04
# BASED ON: agents/champion.py
# CHANGELOG: Changed threat_eta >= 35.0 to 25.0
import math
