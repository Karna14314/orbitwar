# HYPOTHESIS: Adjust defensive triage to abandon doomed planets earlier
# ROUND: 1 | DATE: 2026-06-05
# BASED ON: champion.py
# CHANGELOG: Lowered threat_eta cutoff from 35.0 to 25.0 to abandon doomed planets earlier
import math
