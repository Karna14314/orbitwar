# HYPOTHESIS: Defensive Triage Condition Tuning
# ROUND: 1 | DATE: 2024-05-26
# BASED ON: champion.py
# CHANGELOG: Increase threat ETA to triage earlier
import math
...
def compute_moves(state, pid):
    ...
    for p in mine:
        ...
        # CHANGELOG: Increased threat_eta threshold to triage earlier (from 25.0 to 35.0)
