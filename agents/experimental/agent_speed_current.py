# HYPOTHESIS: Hyper-optimized speed scalars and safety margins
# ROUND: 1 | DATE: 2024-05-31
# BASED ON: champion.py
# CHANGELOG: send buffer 1.35->1.42, safety_need 1.3->1.4
import math
...
def compute_moves(state, pid):
    ...
    for p in mine:
        ...
        safety_need = int(incoming_ships * 1.4 + 4)
