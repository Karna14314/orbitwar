# HYPOTHESIS: Tweak speed-scaling variables and combat tracking thresholds based on recent failure logs
# ROUND: 1 | DATE: 2026-06-05
# BASED ON: champion.py
# CHANGELOG: Combined speed buffer 1.38, threat ETA 30.0, and wave EV multiplier 1.6
import math
