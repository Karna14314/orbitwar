"""
Round-robin tournament for the 4 experimental agents.
Each pair of agents plays 4 games (as standard in previous runner).
...
N_GAMES = 10          # Requested 10 games per pair
ELO_K   = 32
...
def run_tournament():
    ...
    with open('tournament/exp_tournament_results.json', 'w') as f:
